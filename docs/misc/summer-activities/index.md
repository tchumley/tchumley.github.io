...
[Elliot Haugen]: elliot.jpg {class="img-responsive" height=50 style="float: right;"}
[Assem Amangeldina]: assem.jpg {class="img-responsive" width=300px style="float: right;"}
[Kylee Miller]: kylee.jpg {class="img-responsive" height=50 style="float: right;"}
...
[Hollis Welling]: hollis.jpg {class="img-responsive" height=50px style="float: right;"}
